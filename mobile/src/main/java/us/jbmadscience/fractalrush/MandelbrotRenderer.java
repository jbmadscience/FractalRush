...
public class MandelbrotRenderer implements GLSurfaceView.Renderer {
    ...
    private static final String TAG = "MandelbrotRenderer";
...
//    private Square   mSquare;
    ...
    private String _viewVertexShaderCode;
    private String _mandelbrotShaderCode;
//
//
...
//    private float mAngle;
    ...
    public MandelbrotRenderer(String viewVertexShaderCode, String mandelbrotShaderCode) {
        //super();

        _viewVertexShaderCode = viewVertexShaderCode;
        _mandelbrotShaderCode = mandelbrotShaderCode;
    }
...
//        mSquare   = new Square();
        mFractal = new Mandelbrot(_viewVertexShaderCode, _mandelbrotShaderCode);
    }
...
//        Matrix.frustumM(mProjectionMatrix, 0, -ratio, ratio, -1, 1, 3, 7);
    ...
    * MandelbrotRenderer.checkGlError("glGetUniformLocation");</pre>
    *
